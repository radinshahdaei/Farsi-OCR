...
class NormalizationConfig:
    ...
    persian_normalizations: bool = True
    """Apply Persian-specific fixes: ؤ→ؤ, ة→ه, ۀ→هٔ.
    WARNING: May corrupt legitimate Arabic text. Disable for Quranic verses."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Preserve Arabic letter forms (for Quranic verses, Arabic quotations)",
    )
